import unittest
from my_function import triangle_type
...
class TestTriangle(unittest.TestCase):
    ...
    def test_invalid_input(self):
        ...
        self.assertEqual(triangle_type(-1, 2, 3), "Invalid input.")

        # Invalid input with a side having a value greater than 100
        self.assertEqual(triangle_type(200, 2, 3), "Invalid input.")

        # Invalid input with all sides having the same invalid value
        self.assertEqual(triangle_type(-5, -5, -5), "Invalid input.")
